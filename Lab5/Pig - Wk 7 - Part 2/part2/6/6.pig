...
moviesData = LOAD '/home/cloudera/Desktop/lab5Pig/Part2/movies.csv' USING CSVLoader AS(movieId:int, title:chararray, genres:chararray);
...
STORE topAdventureMovies INTO '/home/cloudera/Desktop/lab5Pig/Part2/pigOutput' USING org.apache.pig.piggybank.storage.CSVExcelStorage(',', 'YES_MULTILINE','UNIX', 'WRITE_OUTPUT_HEADER');
